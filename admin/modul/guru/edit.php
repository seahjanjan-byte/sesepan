...
<head>
    <title>Edit Guru - Admin SDN Dukuhbenda 02</title>
                ...
                <div class="card-Dukuhbenda 02-body p-4">
                    <form action="proses.php?aksi=edit" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="index.php" class="btn-secondary-Dukuhbenda 02 text-decoration-none">Batal</a>
                            <button type="submit" class="btn-primary-Dukuhbenda 02">Simpan Perubahan</button>
                        </div>
                    </form>
                </div>
            </div>
