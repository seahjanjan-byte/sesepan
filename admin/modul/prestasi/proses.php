...
if($aksi == 'tambah'){
    ...
    mysqli_query($conn, "INSERT INTO prestasi (judul_prestasi, tgl_prestasi, keterangan, gambar) VALUES ('$judul', '$tgl', '$ket', '$nama_file')");
    ...
    if($gambar != ""){
        ...
        $sql = "UPDATE prestasi SET judul_prestasi='$judul', tgl_prestasi='$tgl', keterangan='$ket', gambar='$nama_baru' WHERE id='$id'";
    } else {
