...
if (isset($_POST['update'])) {
    ...
    if (!empty($gambar)) {
        ...
        $sql = "UPDATE profil SET isi='$isi', gambar='$nama_file', id_admin='$admin_id' WHERE kategori='struktur'";
    } else {
        $sql = "UPDATE profil SET isi='$isi', id_admin='$admin_id' WHERE kategori='struktur'";
    }
