<footer class="bg-dark text-white pt-5 pb-4 mt-5">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 mb-4 ps-lg-5">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2"><a href="guru.php" class="text-white text-decoration-none opacity-75 hover-opacity-100">Daftar Guru</a></li>
                    <li class="mb-2"><a href="fasilitas.php" class="text-white text-decoration-none opacity-75">Fasilitas Sekolah</a></li>
                    <li class="mb-2"><a href="pengumuman.php" class="text-white text-decoration-none opacity-75">Daftar Pengumuman</a></li>
                    <li class="mb-2"><a href="ppdb.php" class="text-white text-decoration-none opacity-75">Info Pendaftaran</a></li>
                </ul>
            </div>
        ...
        <div class="text-center">
            <p class="small mb-0 opacity-50">&copy; 2026 SDN Sesepan. All Rights Reserved.</p>
        </div>
    </div>
</footer>
...
<script>
  AOS.init({
    ...
    offset: 120     // Animasi muncul 120px sebelum elemen terlihat
  });
</script>
</body>
</html>